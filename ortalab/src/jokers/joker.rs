...
pub trait JokerEffect {
    ...
    fn apply_on_scored(&mut self, _state: &mut ScoringState, _played_card: &crate::cards::PlayedCard, _joker_card: &JokerCard) {}
    fn apply_on_held(&self, _state: &mut ScoringState, _held_card: &crate::cards::PlayedCard, _joker_card: &JokerCard) {}
}
